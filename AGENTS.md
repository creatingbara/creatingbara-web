...
## Notas para agentes (Codex y otros)
- Este archivo es idéntico a `CLAUDE.md`: cualquier agente debe seguir las mismas reglas.
- **Commits:** mensajes en español, imperativo y cortos (ej.: `Agrega artículo sobre bios de Instagram`).
- **Definition of Done:** el checklist de arriba completo + el sitio navega sin errores en el servidor local.
- Ante cualquier duda de marca (color, tono, logo), la regla es conservadora: **no improvisar**, dejar un comentario y preguntar.
